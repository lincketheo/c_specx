...
u32
cbuffer_copy (void *dest, const u32 size, const u32 n,
...
u32
cbuffer_write (const void *src, const u32 size, const u32 n,
               struct cbuffer *b)
{
  DBG_ASSERT (cbuffer, b);
  ASSERT (src);
...
u32
cbuffer_cbuffer_move (struct cbuffer *dest, const u32 sz, const u32 cnt,
                      struct cbuffer *src)
{
...
u32
cbuffer_cbuffer_copy (struct cbuffer *dest, const u32 sz, const u32 cnt,
...
i32
cbuffer_read_from_file_1 (i_file *src, const struct cbuffer *b,
...
err_t
cbuffer_read_from_file_1_expect (i_file *src, const struct cbuffer *b,
                                 const u32 len, error *e)
{
...
i32
cbuffer_read_from_file (i_file *src, struct cbuffer *b, const u32 len,
                        error *e)
{
  DBG_ASSERT (cbuffer, b);
  ASSERT (src);
...
i32
cbuffer_write_to_file_1 (i_file *dest, const struct cbuffer *b,
                         const u32 len, error *e)
{
  ASSERT (dest);
  ASSERT (b);
...
err_t
cbuffer_write_to_file_1_expect (i_file *dest, const struct cbuffer *b,
                                const u32 len, error *e)
{
...
i32
cbuffer_write_to_file (i_file *dest, struct cbuffer *b, const u32 len,
                       error *e)
{
  DBG_ASSERT (cbuffer, b);
  ASSERT (dest);
...
static u8
cbuffer_get_no_check (void *dest, const u32 size, const u32 idx,
                      const struct cbuffer *b)
{
  DBG_ASSERT (cbuffer, b);
  ASSERT (size > 0);
...
bool
cbuffer_get (void *dest, const u32 size, const u32 idx,
             const struct cbuffer *b)
{
  DBG_ASSERT (cbuffer, b);
  ASSERT (dest);
